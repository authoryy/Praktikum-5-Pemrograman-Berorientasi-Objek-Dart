class Point {
  int _x;
  int _y;
  static int counter = 0; // Variabel statis counter untuk menghitung jumlah objek Point yang dibuat
...
void main(List<String> args) {
  ...
  print('Pada saat a dibuat, counter bernilai ${Point.counter}'); // Cetak nilai counter setelah objek a dibuat
  b = Point(); // Inisialisasi objek b menggunakan konstruktor default
  print('Pada saat b dibuat, counter bernilai ${Point.counter}'); // Cetak nilai counter setelah objek b dibuat
  c = Point.createInstance(2, 3); // Inisialisasi objek c menggunakan konstruktor createInstance
  print('Pada saat c dibuat, counter bernilai ${Point.counter}'); // Cetak nilai counter setelah objek c dibuat
}
